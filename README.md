...
## Important Note
This project was created as an example use case of ButterCMS in conjunction with a blog article, [Astro Tutorial: Create an Out-Of-This-World Knowledge Base with ButterCMS](https://buttercms.com/blog/astro-tutorial-knowledge-base/), and will not be actively maintained.
